							...
							<div class="agileinfo-cdr">
                                ...
                                <div class="card-body p-b-20">
                                    <div class="list-group">
                                        ...
                                        <a class="list-group-item media" href="">
                                            <div class="pull-left">
                                                <img class="lg-item-img" src='<c:url value="/resources/images/in2.jpg"/>' alt="">
                                            </div>
                                            <div class="media-body">
                                                <div class="pull-left">
                           ...
                           <div class="menu">
									<ul id="menu" >
										<li><a href="/dashboard"><i class="fa fa-tachometer"></i> <span>Dashboard</span><div class="clearfix"></div></a></li>
										 ...
										 <li id="menu-academico" ><a href="themsp"><i class="fa fa-cube"></i><span>Category</span><div class="clearfix"></div></a></li>
