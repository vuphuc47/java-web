...
<!-- Bootstrap Core CSS -->
<link rel="stylesheet" type="text/css" href='<c:url value="/resources/bootstrap-3.4.1-dist/css/bootstrap.min.css"/>'>
<!-- Custom CSS -->
	   			...
	   			<tbody>
	   				<c:forEach var="o" items="${listsp }">
	   					<tr>
							...
							<td class="tensp" data-masp="${o.getMasanpham() }">${o.getTensanpham() }</td>
							<td class="giatien">${o.getGiatien() }</td>
							<td class="mota">${o.getMota() }</td>
	   					</tr>
	   				</c:forEach>
	   			</tbody>
	   		</table>
                           ...
                           <div class="menu">
									<ul id="menu" >
										<li><a href="index.html"><i class="fa fa-tachometer"></i> <span>Dashboard</span><div class="clearfix"></div></a></li>
										 ...
										 <li id="menu-academico" ><a href="#"><i class="fa fa-cube"></i><span>Category</span><div class="clearfix"></div></a></li>
